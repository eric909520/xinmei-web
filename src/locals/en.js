export default {
    ...
    blobal_details: 'Jiangsu Xinmei Photovoltaic Technology Co., Ltd.has strong strength, sufficient funds and excellent after- sales service.Relying on the strong capital and technical advantages of C & S IKE Group Company.The business covers more than 30 countries and regions, among which the company has established companies in Greece, Europe, Shanghai, Xuzhou, Hefei and Tianjin, China. ',
    partener: "Partner",
    news_desc: "The latest developments or news officially released by Xinmei, providing you with first-hand information about Xinmei Photovoltaics",
    ...
    concact_desc: "You can contact Xinmei Photovoltaics through the following methods",
    table_number: "serial number",
    material_name: "Material name",
    material_type: "material type",
    material_use: "Description/Use",
    main_company: "Headquarters",
    main_company_name: "Jiangsu Xinmei Photovoltaic Technology Co., Ltd.",
    ...
    other_company1: 'overseas branch',
    other_company1_name: 'WANG O.E. "ELECTRIC POWER PATRAS"',
    other_company1_address: 'N.E.O. Patron - Athinon 74, Patra 264 42',
    other_company2: 'Changzhou Branch',
    other_company2_name: 'Jiangsu Huishenxing Photovoltaic Technology Co., Ltd.',
    other_company2_address: 'Room 505, 5th Floor, Jingwei Building, No. 7 Yanzhengzhong Avenue, Hutang Town, Wujin District, Changzhou City',
    other_company3: 'Tianjin Branch',
    other_company3_name: 'Xineng Electric Power Engineering (Tianjin) Co., Ltd.',
    other_company3_address: 'Building B, Tianjin International Trade Center, No. 39 Nanjing Road, Hexi District, Tianjin',
    address: "address",
    email: "Mail",
    phone: "Telephone",
    language: 'language',
    ...
    road1: "C & S IKE Group invests in Jiangsu Xinmei Photovoltaic Technology Co., Ltd.",
